...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/permissions/unavail.android.hardware.nfc.xml:$(TARGET_COPY_OUT_ODM)/etc/permissions/sku_d/unavail.android.hardware.nfc.xml
...
ODM_MANIFEST_D_FILES := \
    $(LOCAL_PATH)/vintf/manifest_d.xml
